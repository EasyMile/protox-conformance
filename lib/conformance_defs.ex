defmodule Protox.Conformance.Defs do
  ...
  use Protox.Define,
    enums: [
      ...
      {
        ProtobufTestMessages.Proto3.AliasedEnum,
        [
          {0, :ALIAS_FOO},
          {1, :ALIAS_BAR},
          {2, :ALIAS_BAZ},
    ...
    messages: [
      ...
      },
      {
        ...
        [
          ...
          {18, :none, :optional_nested_message, {:default, nil},
           {:message, ProtobufTestMessages.Proto2.NestedMessage}},
          {19, :none, :optional_foreign_message, {:default, nil},
           {:message, ProtobufTestMessages.Proto2.ForeignMessage}},
          {21, :none, :optional_nested_enum, {:default, :FOO},
           {:enum, ProtobufTestMessages.Proto2.NestedEnum}},
          {22, :none, :optional_foreign_enum, {:default, :FOREIGN_FOO},
           {:enum, ProtobufTestMessages.Proto2.ForeignEnum}},
          ...
          {71, :none, :map_string_nested_message, :map,
           {:string, {:message, ProtobufTestMessages.Proto2.NestedMessage}}},
          {72, :none, :map_string_foreign_message, :map,
           {:string, {:message, ProtobufTestMessages.Proto2.ForeignMessage}}},
          {73, :none, :map_string_nested_enum, :map,
           {:string, {:enum, ProtobufTestMessages.Proto2.NestedEnum}}},
          {74, :none, :map_string_foreign_enum, :map,
           {:string, {:enum, ProtobufTestMessages.Proto2.ForeignEnum}}},
      ...
      },
      {
        ...
        [
          ...
          {19, :none, :optional_foreign_message, {:default, nil},
           {:message, ProtobufTestMessages.Proto3.ForeignMessage}},
          {21, :none, :optional_nested_enum, {:default, :FOO},
           {:enum, ProtobufTestMessages.Proto3.NestedEnum}},
          {22, :none, :optional_foreign_enum, {:default, :FOREIGN_FOO},
           {:enum, ProtobufTestMessages.Proto3.ForeignEnum}},
          ...
          {70, :none, :map_string_bytes, :map, {:string, :bytes}},
          {71, :none, :map_string_nested_message, :map,
           {:string, {:message, ProtobufTestMessages.Proto3.NestedMessage}}},
          {72, :none, :map_string_foreign_message, :map,
           {:string, {:message, ProtobufTestMessages.Proto3.ForeignMessage}}},
          {73, :none, :map_string_nested_enum, :map,
           {:string, {:enum, ProtobufTestMessages.Proto3.NestedEnum}}},
          {74, :none, :map_string_foreign_enum, :map,
           {:string, {:enum, ProtobufTestMessages.Proto3.ForeignEnum}}},
          {75, :repeated, :packed_int32, :packed, :int32},
          {76, :repeated, :packed_int64, :packed, :int64},
          {77, :repeated, :packed_uint32, :packed, :uint32},
          {78, :repeated, :packed_uint64, :packed, :uint64},
